...
#     ranking = GameRank1.objects.values('username')
#     return render(request, 'gamerank_list.html', {'username': ranking})
#     # return render(request, 'gamerank_list.html', {'username': username,'rankinglist': rankingVal})
#
